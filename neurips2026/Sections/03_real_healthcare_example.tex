...
\textbf{Limitations}
Our analysis reveals that sign flips in the explained and unexplained components of the (N)OBD in a real dataset.
It is possible that this dataset or our analysis are unusual, and that sign flips may not occur in other settings.
...
The data have previously been analyzed by \citet{bach2024heterogeneity}, reducing the concern that our empirical results are due to atypical choices.
We also give a theoretical account of sign flips in \cref{sec:signflips}, establishing that they correspond to a nontrivial region of the parameter space.