...
For example, in analyses of the labor market, $\beta^*$ sometimes represents the $Y \mid X$ relationship in the absence of wage discrimination \citep{neumark1988}; there may be no similarly-defined object to estimate, or feasible approach to estimate it in other contexts. 
