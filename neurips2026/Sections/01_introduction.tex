...
give an existence proof (with real data) that the OBD \emph{can} yield two substantively different conclusions (\cref{sec:real_example}).\footnote{We release all of our code to replicate the experiments at the following repository, \url{https://github.com/manuelquinteroc/ReferenceOaxacaBlinder}.}
