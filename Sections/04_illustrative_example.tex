...
For both choices of reference group the explained components are negative, so both choices of reference imply that $H$'s lower average SBP is in part to its lower average BMI.
