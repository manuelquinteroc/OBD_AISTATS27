...
First, approaches like those of \citet{neumark1988,oaxacaRansom1994,reimers1983,cotton1988,kassenboehmer2014distributional,sharafRashad2016,rahimiNazari2021,Allen2022,bachan2022genderchancellor} define a new reference group by aggregating $H$ and $K$; however, there are multiple ways of defining this reference group. So while this removes the choice of $H$ versus $K$ as the reference group, it introduces a new arbitrary choice.
...
But, as our results call into question the validity of the explained and unexplained components for either reference group, this seems to be an average of two questionable quantities.
