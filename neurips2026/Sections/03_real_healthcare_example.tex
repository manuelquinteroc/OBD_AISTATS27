...
Concerningly, we see that \emph{every} model contains at least one sign flip, and more complex models tend to have even more sign flips; for TabPFN, we see that more than one half of the datasets show opposite signs for at least one of the explained or unexplained components and $13.7\%$ show significant sign flips at the $5\%$ level.
