...
Given the results in \cref{sec:real_example}, a natural question to ask is whether such sign reversals can arise in more stylized settings could be due to model mispecification or sampling variability. Here, we present a simple simulated example inspired by real-life healthcare data that exhibits sign reversals in the OBD under correct model specification and large sample sizes, demonstrating that these issues are not merely artifacts of small samples or model misspecification.
...
\begin{figure*}[t]
\vspace{.3in}
\centerline{\includegraphics[width=0.8\textwidth]{Sections/Figures/counterfactual.pdf}}
\vspace{.3in}
