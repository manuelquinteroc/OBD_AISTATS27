...
\textcolor{red}{When the two reference groups yield the same sign, the conclusion is robust to the choice of reference group. When they yield opposite signs, no reference-robust directional conclusion is available; analysts should avoid selective directional claims and may instead investigate heterogeneity or transportability, but the (N)OBD alone cannot determine which reference group is policy-relevant.}
