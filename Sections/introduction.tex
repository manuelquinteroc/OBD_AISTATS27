...
\cref{sec:counterfactual_example} illustrates the index-number problem and \cref{sec:ob} reviews the OBD.
\cref{sec:example} presents a simulated healthcare example that illustrates a sign-reversal in practice and \cref{sec:real_example} then provides a real clinical case study in ICU mortality that exhibits the same qualitative instability. \cref{sec:signflips} establishes theoretical conditions under which sign reversals can occur and \cref{sec:no_sign_flips} complements this with conditions under which sign reversals cannot occur. 
