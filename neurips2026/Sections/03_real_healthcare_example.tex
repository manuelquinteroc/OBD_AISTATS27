...
\textcolor{red}{Table XXX} counts the number of sign flips across these models at various levels of statistical significance.
...
\textcolor{red}{Table XXX} shows that sign flips are common.
...
As a first pass at answering our questions, we examine one particular data subset from \textcolor{red}{Table XXX}.
...
In \textcolor{red}{Appendix where sec 4 goes}, we show that these phenomenon are not artifacts of finite-samples or model mis-specification -- indeed, they can occur for well-specified linear models with infinite data.
