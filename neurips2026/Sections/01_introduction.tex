...
Recent work has explored pairing the OBD with flexible ML decompositions \citep{quintero2025,bach2024heterogeneity,quintas2024multiply,mao2025double,flachaire2025decomposing}, but has not engaged with the index number problem.
...
\textcolor{red}{We show that the OBD is more sensitive to reference choice when paired with ML models (Section TODO).}
