...
We now supply such an illustration with real healthcare data.
...
We report the OBD for each reference group in Appendix \cref{tab:hr_q2_decomposition}. We next interpret the substantive conclusions
...
In \cref{appendix:how-does-flip-arise} we show how differences in linear regression coefficients for men and women lead to this reversal.
...
One concern is that sign flips may be specific to this dataset; in \cref{appendix:real_data} we address this with a second illustration on U.S. Census data previously analyzed by \citet{bach2024heterogeneity}.
