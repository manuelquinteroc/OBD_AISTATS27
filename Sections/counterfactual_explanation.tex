...
Which counterfactual is more appropriate can depend on the question of interest and carries distinct interpretations and policy implications, sometimes the counterfactual choice is driven by domain knowledge such as in labor economics where there seems to be a consensus for the gender wage gap problem \citep{}. However, in many cases, the choice of the reference group is usually not clear, such as in the SBP--BMI example.


% \textcolor{red}{Write that it is not clear which counterfactual to use, although in some cases it is clear, as in these examples it is not.}
