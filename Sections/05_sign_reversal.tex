...
\label{prop:unexplained_fraction}
	Suppose $\mu_K = 0$ and $\mu_H = 1 \in \R^d$.
...
And, while not all applications of the OBD in the literature report both choices of reference group $g$, those that we found to report both do not exhibit a sign flip \citep{ONeill2006, fortinLemieuxFirpo2011, sharafRashad2016, rahimiNazari2021}.
