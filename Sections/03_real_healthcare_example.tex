...
\textcolor{red}{AS: I swapped this from ``tachycardia'' to ``elevated heart rate'', since the HR in this quartile (89-103) is mostly below the tachycardia range (100+).}
...
\textbf{Analysis.}
As discussed in \cref{sec:ob_real}, practitioners often draw conclusions based on the sign of the explained and unexplained components, assuming the sign is statistically significant.
...
So how concerning are the subsets? And why are they happening? Well, let's study this for the linear regression case, since it's the simplest model.
