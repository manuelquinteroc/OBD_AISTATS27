...
We can represent
\begin{align*}
    &\Delta \alpha = 2M (I_2 - 1) 
    &\Delta \beta  = 2M (J_{2d} - d)
\end{align*}
...
\begin{align*}
    ...
    =& 
    Pr \left( \{ \Delta \alpha > 0 \} \cap \{ \Delta \beta < - \Delta \alpha \} \right)
    +
    Pr \left(
    \{ \Delta \alpha < 0 \} \cap \{ \Delta \beta > - \Delta \alpha \} \right) \\
    =& 
...
The corresponding fraction of $C_M$ leading to sign flips is therefore \( 0.5 \).
