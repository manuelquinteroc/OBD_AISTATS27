...
Since the original paper \citep{oaxaca1973}, it has been well known that the OBD requires choosing one of the two groups (Patients Groups $K$ or $H$ in our example) as a reference, and that this choice affects the numerical result of the OBD.
