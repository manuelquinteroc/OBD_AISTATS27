...
We provide the proof of \cref{thm:ordering_sensitivity} in \cref{sec:sign_flip_proof}, and represent the conditions in \cref{eq:sign_flip_condition} as a decision tree in \cref{alg:decision_tree}.
