...
\textcolor{red}{TODO explain how we get to the following.}
For the explained component, the Shapley proposal is $E = (1/2)E^{(H)} + (1/2) E^{(K)}$.
...
A second approach, from \citet{neumark1988pooling}, is to create a pooled dataset consisting of all samples from $H$ and $K$, and estimate $\beta^*$ from this dataset.
