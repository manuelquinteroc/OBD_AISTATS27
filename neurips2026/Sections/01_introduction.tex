...
\textcolor{red}{We fill this gap by characterizing when the OBD's substantive conclusions are sensitive to the reference group, empirically documenting this sensitivity grows when the OBD is paired with more flexible regression models, and providing theory to explain this sensitivity.}
