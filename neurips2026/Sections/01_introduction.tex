...
While recent work has explored pairing the OBD with flexible functional decompositions \citep{quintero2025,bach2024heterogeneity,quintas2024multiply,mao2025double,flachaire2025decomposing}, it has not engaged with the index number problem; see \cref{appendix:obd_generalized} for more discussion.
