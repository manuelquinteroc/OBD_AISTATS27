...
\begin{align}
  \mathbb{E}_{X \sim P_i}[ \mathbb{E}_{Y \sim H}[Y \mid X] ] - \mathbb{E}_{X \sim P_{i-1}} [ \mathbb{E}_{Y \sim H} [Y \mid X]] \\
  \mathbb{E}_{X \sim P_i}[ \mathbb{E}_{Y \sim K}[Y \mid X] ] - \mathbb{E}_{X \sim P_{i-1}} [ \mathbb{E}_{Y \sim K} [Y \mid X]].
\end{align}  
