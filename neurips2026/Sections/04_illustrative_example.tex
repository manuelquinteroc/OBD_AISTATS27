...
\label{sec:example}
\textcolor{red}{AS: I think we should move this section to the appendix. The theory also establishes that flips can occur under correct specification and in the unexplained component. We can use the space to (1) show sign flips with ML models in the heart rate example (so it's not just OLS that has problems), and (2) prevalence of sign flips in the systematic search (more common with ML models).}
