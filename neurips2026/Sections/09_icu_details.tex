...
% Insurance
\begin{table}[!ht]
    \caption{Number of subgroups (out of $217$) exhibiting a sign flip in the explained and unexplained component, for the earnings outcome.}
    \label{tab:flips_census_income}
    \centering
    \small
    \begin{tabular}{lccc}
    \toprule
          & \multicolumn{1}{c}{Either Component} & \multicolumn{1}{c}{Explained Component} & \multicolumn{1}{c}{Unxplained Component} \\
          \cmidrule(lr){2-2} \cmidrule(lr){3-3} \cmidrule(lr){4-4}
    Model & Total flips & Total flips & Total flips \\
    \midrule
    Linear      & 35 & 24 & 11 \\    
    lightgbm    & 29 & 23 & 6  \\
    \bottomrule
...
% 
\begin{table}[!ht]
    \caption{Number of subgroups (out of $183$) exhibiting a sign flip in the explained and unexplained component, for the health insurance outcome.}
    \label{tab:flips_census_income}
    \centering
    \small
    \begin{tabular}{lccc}
