...
Recent work has explored pairing the OBD with flexible ML decompositions \citep{quintero2025}, with a particular focus on statistical inference \citep{bach2024heterogeneity,quintas2024multiply,flachaire2025decomposing}.
...
\textcolor{red}{We show that pairing the OBD is more sensitive to reference choice when paired with ML models (Section TODO).}
