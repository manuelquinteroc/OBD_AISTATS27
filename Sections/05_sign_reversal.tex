...
\begin{figure}
    ...
    \caption{Fraction of parameter space leading to sign flips of the unexplained component from \cref{prop:unexplained_fraction}.\textcolor{red}{Will: we still haven't gotten cleverref to correctly name things as, e.g., Proposition 5.8 -- it's still saying Theorem} \textcolor{orange}{MQ: in mine it says Proposition 5.8. Maybe try pulling the latest mathnotation.tex file}}
