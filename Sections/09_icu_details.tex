...
\begin{table}[H]
    \centering
    \caption{ICU Mortality Gap Decomposition for Subgroups Exhibiting Sign Reversals. Standard errors in parentheses are computed via bootstrap resampling with $20{,}000$ replications.  
