...
This type of decomposition is well-suited to many tasks in machine learning explainability, but does not, by itself, separate differences between two populations into differences in the distribution of $X$ versus differences in the distribution of $Y|X$.
