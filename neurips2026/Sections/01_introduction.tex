...
Recent work has explored pairing the OBD with flexible ML decompositions \citep{quintero2025,bach2024heterogeneity,quintas2024multiply,mao2025double,flachaire2025decomposing}, but has not engaged with the index number problem; see \cref{appendix:obd_generalized} for more discussion.
...
\textcolor{red}{We fill this gap by characterizing when the OBD's substantive conclusions are sensitive to the reference group, empirically documenting this sensitivity grows for ML models, and providing theory to explain this sensitivity.}
...
\textcolor{red}{ and show that the OBD is more sensitive to reference choice when paired with ML models (\cref{sec:real_example}).}
