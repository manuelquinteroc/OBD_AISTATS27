...
We also introduce the notation $\mu_g := \mathbb{E}_g[X]$.
With these choices,
...
\textcolor{red}{why is this next part here?}
Now further let
\[
...
\]
With this notation, we can write the two possible decompositions, one for each choice of reference group, as: \textcolor{red}{equations below use E and U macros that equations above dont use}
\textcolor{orange}{Aren't the macros below just the macros above, with the deltas substituted in?}
\begin{align}
