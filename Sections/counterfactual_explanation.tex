...
Consider again our example, where $Y$ represents mortality and $X$ represents risk factors. Suppose we think the conditional distribution $Y|X$ corresponds to the quality of medical care for the given risk factors.
Then we might ask:
