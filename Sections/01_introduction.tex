...
As a motivating example, suppose a public health worker in City $K$ notices that her city's mean systolic blood pressure (SBP) is concerningly higher than a neighboring city, City $H$.
She notices that the medical literature shows a relation between body mass index (BMI, $X$) and SBP ($Y$).
The observed differences in mean SBP could be due to differences in citizens' BMI (distribution of $X$) or to differences in medical care access that determine how SBP is affected by BMI (distribution of $Y|X$).
...
Some papers report results for both references \citep{oaxaca1973,blinder1973,ONeill2006,sharafRashad2016,rahimiNazari2021}. 
...
e.g., in our example, both references might say the SBP difference between cities is driven in part by BMI and just differ in how much.
...
the SBP difference is driven by BMI and the other says it is not.
