...
$\mu_K=0$. How to standardize population spread and how to handle the second group are less obvious,
but we address both of these challenges by choosing $\mu_H =1$. We note that our standardization choice ($\mu_K=0,\mu_H=1$) is
...
\textcolor{red}{appendix}. We conclude from this search that we do not expect sign flips to be more than empirically rare, but
...
See \textcolor{red}{appendix} for details of this dataset and our search procedure.
