...
\textcolor{red}{One concern is that sign flips may be specific to this dataset; in \cref{appendix:real_data} we address this with a second illustration on U.S. Census data previously analyzed by \citet{bach2024heterogeneity}.}
