...
(A) \emph{How would Hospital $H$'s mortality rate change if patients stayed at the same hospital but had the risk factor distribution of patients at Hospital $K$?}
...
(B) \emph{How would Hospital $K$'s mortality rate change if patients stayed at the same hospital but had the risk factor distribution of patients at Hospital $K$?}
...
This tendency might suggest a consensus; however, we also observe published work that takes men or women as the reference group \citep{nielsen2000wage,piazzalunga2019increase,leythienne2021paygapeu,tao2024gender,paradaContzen2025}.
