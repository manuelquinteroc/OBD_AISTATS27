...
This asymmetry arises because the OBD involves computing differences in covariate means and regression coefficients between the two populations; the choice of which direction to do the subtraction---implicitly setting a reference group---typically yields different results.
