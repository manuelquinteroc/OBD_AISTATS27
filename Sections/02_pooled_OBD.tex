...
We assume they estimate $\mathbb{E}_g[Y|X]$ separately in each group with $\hat{M}_g(X)$, such as ordinary least squares (OLS) or an ML algorithm.

apply \cref{eq:OB_H_decomp,eq:OB_K_decomp} with the fitted intercept and 
