...
Since the original paper \citep{oaxaca1973}, it has been well known that the OBD requires choosing one of the two groups (Patients Groups $K$ or $H$ in our example) as a reference, and the numerical result returned by the OBD can change with the choice of reference; this dependence on the reference choice is sometimes known as the ``index-number problem.''
