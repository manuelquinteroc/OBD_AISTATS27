...
\begin{table}[H]
\caption{Population Oaxaca–Blinder decomposition of mean SBP differences}
\label{tab:ob_decomp}
\begin{center}
\small
\begin{tabular}{lrrr}
