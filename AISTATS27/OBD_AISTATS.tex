...
\newcommand{\rc}[1]{\textcolor{red}{#1}}   % red for edited table cells
\colorlet{RED}{red}         % the aistats2027 style upper-cases section titles, turning \textcolor{red} into \textcolor{RED}
