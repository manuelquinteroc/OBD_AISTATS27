...
\label{appendix:ovb}
Since unexplained component sign flips require \( | \mathbf{1}^T \Delta \beta | > | \Delta \alpha | \), any data-generating processes that jointly produces large \( | \mathbf{1}^T \Delta \beta | \) and \( | \Delta \alpha | \) would make sign flips less likely than \cref{prop:unexplained_fraction} suggests.
