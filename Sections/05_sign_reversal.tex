...
\begin{figure}
    ...
    \caption{Percentage of parameter space leading to sign flips.}
...
In particular, for convenience, we set $\mu_K=0$ and $\mu_H=1$. We then measure the fraction of parameters ($\beta_g, \alpha_g)$ for $g \in \{H,K\}$ that lead to sign flips. As the next two propositions demonstrate, the fraction leading to sign flips is fairly large.
\textcolor{red}{argue more clearly about the mu choices, bring up \cref{lemma:units}}
